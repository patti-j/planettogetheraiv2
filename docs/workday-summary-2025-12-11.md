...
| File | Purpose |
|------|---------|
| `scripts/import-knowledge-base.ts` | Main import script |
| `server/services/knowledge-chunking.ts` | Text chunking logic |
| `server/services/knowledge-retrieval.service.ts` | Search & retrieval |
| `shared/schema.ts` | Database table definitions |

### KB Statistics (Current)
- **184 articles** imported from HubSpot
- **1,035 chunks** with embeddings
- **Embedding model**: text-embedding-3-small (1536 dimensions)
- **Refresh schedule**: Monthly via import script
