...
const pageMapping: Record<string, { label: string; icon: string }> = {
  ...
  '/demand-forecasting': { label: 'Demand Forecasting', icon: 'Wand2' },
  '/demand-planning': { label: 'Demand Planning', icon: 'Wand2' },
  ...
  '/scheduling-optimizer': { label: 'Scheduling Optimizer', icon: 'Wand2' },
