...
function getAgentWelcomeMessage(agent: Agent): string {
  const messages = {
    ...
    scheduling_assistant: `Hi! I'm your AI Scheduling Agent, expert in production scheduling and APS systems. I specialize in:\n\n📚 **PlanetTogether Knowledge** - Finite capacity, pegging, what-if scenarios, and advanced scheduling\n📊 **Bryntum Scheduler** - Features, configuration, and optimization techniques\n⚙️ **APS Best Practices** - Industry standards and proven scheduling methodologies\n🎯 **Problem Solving** - Troubleshooting scheduling conflicts and bottlenecks\n\nI can help you understand complex scheduling concepts, optimize your production plans, and make the most of your scheduling tools. What scheduling question can I help with today?`,
