...
export const navigationGroups: NavigationGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Users, label: "Onboarding Assistant", href: "/onboarding-assistant", feature: "systems-management", action: "view", color: "bg-gradient-to-r from-purple-600 to-pink-500" },
