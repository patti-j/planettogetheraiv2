...
export const navigationGroups: NavigationGroup[] = [
  {
    ...
    features: [
      { icon: Globe, label: "Global Control Tower", href: "/enterprise-map", feature: "systems-management", action: "view", color: "bg-blue-600" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Users, label: "Implementation Consultant", href: "/implementation-consultant", feature: "systems-management", action: "view", color: "bg-gradient-to-r from-purple-600 to-pink-500" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Users, label: "Labor Management", href: "/labor", feature: "labor", action: "view", color: "bg-indigo-500" },
