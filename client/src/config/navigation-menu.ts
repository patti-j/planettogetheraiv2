...
export const navigationGroups: NavigationGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Brain, label: "AI Scenario Creator", href: "/ai-scenario-creator", feature: "systems-management", action: "view", color: "bg-gradient-to-r from-blue-500 to-purple-600" }
    ]
  },
  {
