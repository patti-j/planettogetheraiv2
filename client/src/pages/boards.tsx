    ...
    <div className="flex-1 flex flex-col relative">
      ...
      {!isMobile && (
        <button
          ...
          className="fixed right-12 z-10 top-20 md:top-4 bg-white dark:bg-gray-800 shadow-md hover:shadow-lg border border-gray-200 dark:border-gray-700 rounded-md h-8 w-8 flex items-center justify-center transition-all duration-200"
