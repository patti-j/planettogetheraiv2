    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No Route Parameters</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">Unable to parse route parameters.</p>
