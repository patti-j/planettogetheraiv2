...
const MANUFACTURING_SECTORS = [
  ...
  { name: 'Food Production', icon: Package, description: 'Batch processing with expiration tracking and HACCP compliance' },
  { name: 'Beverage Production', icon: Package, description: 'Fermentation scheduling and packaging line optimization' },
