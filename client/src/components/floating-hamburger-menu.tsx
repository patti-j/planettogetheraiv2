...
export function FloatingHamburgerMenu({ 
  ...
  // Position at right-32 to completely avoid overlap with all page controls (Export, Refresh, Maximize buttons)
  return (
    <div className={`fixed right-32 z-[9999] pointer-events-auto ${
