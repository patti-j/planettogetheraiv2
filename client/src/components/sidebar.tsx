...
export default function Sidebar() {
  ...
  const navigationItems: Array<{
    ...
    { icon: AlertTriangle, label: "Error Logs", href: "/error-logs", active: location === "/error-logs", feature: "systems-management", action: "view" },
    ...
    { icon: Sparkles, label: "Presentation Studio", href: "/presentation-studio", active: location === "/presentation-studio", feature: "presentation-system", action: "view" },
  ...
  const getNavigationTooltip = (href: string) => {
    const tooltips: Record<string, string> = {
      ...
      "/error-logs": "Monitor system errors, track bugs, and manage error resolution with comprehensive logging and reporting",
