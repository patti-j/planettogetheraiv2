    ...
    >
      ...
      {showDockZones && (
        <>
          {/* Left dock zone */}
          <div 
            className="fixed left-0 top-0 w-20 h-full bg-blue-500/30 border-r-4 border-blue-500 z-20 flex items-center justify-center pointer-events-none hamburger-menu-hidden"
          ...
          {/* Right dock zone */}
          <div 
            className="fixed right-0 top-0 w-20 h-full bg-blue-500/30 border-l-4 border-blue-500 z-20 flex items-center justify-center pointer-events-none hamburger-menu-hidden"
            style={{ opacity: isDragging ? 1 : 0, transition: 'opacity 0.2s' }}
          >
          ...
          {/* Top dock zone */}
          <div 
            className="fixed top-0 left-0 w-full h-20 bg-blue-500/30 border-b-4 border-blue-500 z-20 flex items-center justify-center pointer-events-none hamburger-menu-hidden"
            style={{ opacity: isDragging ? 1 : 0, transition: 'opacity 0.2s' }}
          >
          ...
          {/* Bottom dock zone */}
          <div 
            className="fixed bottom-0 left-0 w-full h-20 bg-blue-500/30 border-t-4 border-blue-500 z-20 flex items-center justify-center pointer-events-none hamburger-menu-hidden"
            style={{ opacity: isDragging ? 1 : 0, transition: 'opacity 0.2s' }}
          >
