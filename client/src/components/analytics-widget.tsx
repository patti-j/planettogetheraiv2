  ...
  return (
    <Card 
      ...
      style={{
        ...
        width: `${Math.min(widget.size.width, 300)}px`,
        height: `${Math.min(widget.size.height, 200)}px`,
        maxHeight: `${Math.min(widget.size.height, 200)}px`,
        maxWidth: `${Math.min(widget.size.width, 300)}px`,
